...
function Todo() {
  ...
  return (
    <div className="container flex  h-[100vh] bg-[url('./Images/Background_Image.png')] min-w-full ">
      <div className="hide-scrollbar mx-3 md:container md:ml-20  rounded-xl p-5 bg-violet-100 min-h-[80vh] max-h-[80vh] md:w-[22%] overflow-hidden  overflow-y-scroll self-center ">
      ...
      {/* <h1 className="flex justify-center align-middle texthi text-white ">hey how are you</h1> */}
    </div>
  );
}
