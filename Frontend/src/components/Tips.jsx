  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="p-4 border rounded-md shadow-md max-w-[35vw] min-h-[25vh] max-h-[25vh]:">
        ...
        <p className="text-gray-700 mb-4 overflow-wrap-break-word">{tip.content}</p>
        <button className="bg-violet-500 hover:bg-slate-300 hover:text-violet-500 font-bold py-2 px-4 rounded " onClick={handleRefresh}>
          Refresh
        </button>
      </div>
    </div>
