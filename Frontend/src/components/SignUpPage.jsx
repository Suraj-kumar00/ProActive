      ...
      <div className="bg-gray-700  border-slate-700 border-6 box-content h-[546px] w-[450px]  rounded-2xl pl-[50px] pr-[9px] pt-[50px] pb-[38px] mt-[65px] ml-[-780px]">
        ...
        <div className="flex justify-between">
          ...
          <a
            ...
            className="text-red-400 font-semibold mr-12 cursor-pointer hover:text-red-600"
          >
            forget Password
          </a>
        </div>
        ...
        <div className="mt-3 flex justify-center items-center ml-[-52px]">
          <div className="m-4 border-gray-500 border-[1px] p-2 text-xs h-[40px] w-[160px] rounded-xl mr-2 text-white  flex justify-around items-center">
            <svg
              width="25"
              height="24"
              viewBox="0 0 25 24"
